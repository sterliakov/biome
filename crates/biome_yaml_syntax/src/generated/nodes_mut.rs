...
impl YamlBlockMapExplicitKey {
    ...
    pub fn with_key(self, element: Option<AnyYamlIndentedBlock>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl YamlBlockMapExplicitValue {
    ...
    pub fn with_value(self, element: Option<AnyYamlIndentedBlock>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl YamlFlowInBlockNode {
    ...
    pub fn with_newline_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
