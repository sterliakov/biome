...
const RULES_TO_MIGRATE: &[(&str, (&str, &str))] = &[
    ...
    ("noDocumentCookie", ("suspicious", "noDocumentCookie")),
    ("noDocumentImportInPage", ("suspicious", "noDocumentImportInPage")),
    ("noDoneCallback", ("style", "noDoneCallback")),
    ("noDuplicateElseIf", ("suspicious", "noDuplicateElseIf")),
    ("noDuplicateTestHooks", ("suspicious", "noDuplicateTestHooks")),
    ("noDynamicNamespaceImportAccess", ("performance", "noDynamicNamespaceImportAccess")),
    ("noEnum", ("style", "noEnum")),
    ("noEvolvingTypes", ("suspicious", "noEvolvingTypes")),
    ("noExcessiveNestedTestSuites", ("complexity", "noExcessiveNestedTestSuites")),
    ("noExportedImports", ("style", "noExportedImports")),
    ...
    ("noHeadElement", ("style", "noHeadElement")),
    ("noHeadImportInDocument", ("suspicious", "noHeadImportInDocument")),
    ("noImgElement", ("performance", "noImgElement")),
    ("noIrregularWhitespace", ("suspicious", "noIrregularWhitespace")),
    ("noIrregularWhitespace", ("suspicious", "noIrregularWhitespace")),
    ...
    ("noNestedTernary", ("style", "noNestedTernary")),
    ("noNodejsModules", ("correctness", "noNodejsModules")),
    ("noOctalEscape", ("suspicious", "noOctalEscape")),
    ("noProcessEnv", ("style", "noProcessEnv")),
    ("noReactSpecificProps", ("suspicious", "noReactSpecificProps")),
    ("noReExportAll", ("performance", "noReExportAll")),
    ("noRestrictedImports", ("style", "noRestrictedImports")),
    ("noRestrictedTypes", ("style", "noRestrictedTypes")),
    ("noSkippedTests", ("suspicious", "noSkippedTests")),
    ("noStaticElementInteractions", ("a11y", "noStaticElementInteractions")),
    ("noSubstr", ("style", "noSubstr")),
    ("noSuspiciousSemicolonInJsx", ("suspicious", "noSuspiciousSemicolonInJsx")),
    ("noTemplateCurlyInString", ("suspicious", "noTemplateCurlyInString")),
    ...
    ("noUselessEscapeInRegex", ("complexity", "noUselessEscapeInRegex")),
    ("noUselessStringConcat", ("complexity", "noUselessStringConcat")),
    ("noUselessStringRaw", ("complexity", "noUselessStringRaw")),
    ...
    ("useAdjacentOverloadSignatures", ("suspicious", "useAdjacentOverloadSignatures")),
    ("useAriaPropsSupportedByRole", ("a11y", "useAriaPropsSupportedByRole")),
    ("useArrayLiterals", ("correctness", "useArrayLiterals")),
    ("useAtIndex", ("style", "useAtIndex")),
    ("useCollapsedIf", ("style", "useCollapsedIf")),
    ("useComponentExportOnlyModules", ("style", "useComponentExportOnlyModules")),
    ("useConsistentBuiltinInstantiation", ("style", "useConsistentBuiltinInstantiation")),
    ("useConsistentCurlyBraces", ("style", "useConsistentCurlyBraces")),
    ("useConsistentMemberAccessibility", ("style", "useConsistentMemberAccessibility")),
    ...
    ("useGoogleFontDisplay", ("suspicious", "useGoogleFontDisplay")),
    ("useGuardForIn", ("suspicious", "useGuardForIn")),
    ...
    ("useStrictMode", ("suspicious", "useStrictMode")),
    ...
    ("useTrimStartEnd", ("style", "useTrimStartEnd")),
    ("useValidAutocomplete", ("a11y", "useValidAutocomplete")),
];
